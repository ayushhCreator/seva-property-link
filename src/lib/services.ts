...
export const cities = [
  ...
  },
  {
    ...
    name: 'Kolkata',
    state: 'West Bengal',
    tagline: 'Reliable Property Services in Kolkata',
    description: 'Get certified deed copies, mutation assistance, and rent agreements in Kolkata. BhumiSeva simplifies property documentation across West Bengal.',
    address: 'Salt Lake, Sector V, Kolkata, West Bengal - 700091',
    phone: '+91 98765 43211',
    testimonial: { name: 'Rina Chatterjee', text: 'Very professional service. Got my deed copy within a week. Highly recommended!', rating: 5 },
    keywords: 'property services Kolkata, deed copy Kolkata, mutation West Bengal',
  },
  {
    slug: 'mumbai',
    name: 'Mumbai',
    state: 'Maharashtra',
    tagline: 'Premium Property Documentation in Mumbai',
    description: 'BhumiSeva Mumbai offers expert property documentation services including deed searches, rent agreements, and mutation assistance across Maharashtra.',
    address: 'Andheri East, Mumbai, Maharashtra - 400069',
    phone: '+91 98765 43212',
    testimonial: { name: 'Prashant Deshmukh', text: 'Excellent rent agreement service. Quick, professional, and hassle-free!', rating: 5 },
    keywords: 'property services Mumbai, rent agreement Mumbai, deed search Maharashtra',
  },
];
